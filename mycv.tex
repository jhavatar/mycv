...
Info & Software company that creates task management and team collaboration software. \\
Duties & I work on the new Teamwork project management app that helps managers, staff and clients work together online more productively. 
\end{tabularx}
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{\subSecHeadWidth}X}
\gray Period & \textbf{Apr 2016 --- Aug 2020}\\
...
Duties & As team lead I was responsible for best architecture and design practices during app development, as well as the managing and mentoring of junior Android staff. Notable apps delivered: 
\begin{description}
