...
\textbf{Languages} & Kotlin (5 years), Java (10+ years), JavaScript (5 years) \\
...
Duties & I am responsible for the development of the new Teamwork project management app -- an improved native Android rewrite of the original cross-platform version. The app assists managers, staff, and clients to work together more productively and efficiently.
\end{tabularx}
